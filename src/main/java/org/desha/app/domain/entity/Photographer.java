...
public class Photographer extends Person {
    ...
    @ManyToMany
    @JoinTable(name = "lnk_pays_photographe", joinColumns = @JoinColumn(name = "fk_photographe"), inverseJoinColumns = @JoinColumn(name = "fk_pays"))
    private Set<Country> countries = new HashSet<>();

    @Builder
    public Photographer(Long id, String name, String photoFileName) {
        super();
        this.id = id;
        this.name = name;
