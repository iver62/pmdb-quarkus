...
@Getter
@Setter
@Table(name = "ingenieur_son")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SoundEditor extends Person {
    ...
    @JoinTable(name = "lnk_pays_ingenieur_son", joinColumns = @JoinColumn(name = "fk_ingenieur_son"), inverseJoinColumns = @JoinColumn(name = "fk_pays"))
    private Set<Country> countries = new HashSet<>();

    @Builder
    public SoundEditor(Long id, String name, String photoFileName) {
        super();
        this.id = id;
        this.name = name;
    ...
    public static SoundEditor fromDTO(PersonDTO personDTO) {
        return
                SoundEditor.builder()
