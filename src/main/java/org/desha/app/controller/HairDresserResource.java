...
public class HairDresserResource {
    ...
    @GET
    @Path("{id}")
    public Uni<HairDresser> getHairDresser(Long id) {
        return hairDresserService.getOne(id);
    }
    ...
    public Uni<Response> getMovies(Long id) {
        return
                hairDresserService.getOne(id)
                        .chain(hairDresserService::getMovies)
    ...
    public Uni<Response> save(PersonDTO personDTO) {
        return
                hairDresserService
                        .save(personDTO, HairDresser.builder().build())
                        .onItem().ifNotNull()
                        .transform(hairDresser -> Response.ok(hairDresser).status(CREATED).build())
                ;
    }
    ...
    public Uni<Response> update(Long id, PersonDTO personDTO) {
        ...
        return
                hairDresserService.update(id, personDTO)
                        .onItem().ifNotNull().transform(hairDresser -> Response.ok(hairDresser).build())
