...
public class VisualEffectsSupervisorResource {
    ...
    private final PersonService<VisualEffectsSupervisor> personService;

    @Inject
    public VisualEffectsSupervisorResource(PersonService<VisualEffectsSupervisor> personService) {
