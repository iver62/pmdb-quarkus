...
public class PhotographerResource {
    ...
    private final PersonService<Photographer> personService;

    @Inject
    public PhotographerResource(PersonService<Photographer> personService) {
    ...
    public Uni<Response> save(PersonDTO personDTO) {
        return
                personService
                        .save(personDTO, Photographer.builder().build())
                        .onItem().ifNotNull()
                        .transform(photographer -> Response.ok(photographer).status(CREATED).build())
                ;
    }
    ...
    public Uni<Response> update(Long id, PersonDTO personDTO) {
        ...
        return
                personService.update(id, personDTO)
                        .onItem().ifNotNull().transform(photographer -> Response.ok(photographer).build())
