...
public class EditorRepository extends PersonRepository<Editor> {
    ...
    @Override
    public Uni<Editor> findByIdWithCountriesAndMovies(long id, int pageIndex, int size, String sort, Sort.Direction direction, FiltersDTO filtersDTO) {
        return null;
    }
