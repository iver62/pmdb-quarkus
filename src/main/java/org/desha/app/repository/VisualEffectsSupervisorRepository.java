...
public class VisualEffectsSupervisorRepository extends PersonRepository<VisualEffectsSupervisor> {
    ...
    @Override
    public Uni<VisualEffectsSupervisor> findByIdWithCountriesAndMovies(long id, int pageIndex, int size, String sort, Sort.Direction direction, FiltersDTO filtersDTO) {
        return null;
    }
