...
public class SoundEditorRepository extends PersonRepository<SoundEditor> {
    ...
    @Override
    public Uni<SoundEditor> findByIdWithCountriesAndMovies(long id, Page page, String sort, Sort.Direction direction, FiltersDTO filtersDTO) {
        return null;
    }
